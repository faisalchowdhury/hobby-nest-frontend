            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <p className="mb-9 text-base leading-relaxed text-body-color dark:text-dark-6">
                  Have a hobby you love? Let’s connect you with others who share
                  your passion. Reach out to Hobbynest today and start building
                  meaningful connections around your favorite hobbies.
                </p>
